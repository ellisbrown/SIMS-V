...
# Receptacle types used by the supported simulator metadata.
...
RECEPTACLE_SYNSETS = [
    AI2THOR_OBJECT_TYPE_TO_WORDNET_SYNSET[ot] for ot in RECEPTACLE_TYPES_THOR
]

ALL_PICKUP_SYNSETS = [
    AI2THOR_OBJECT_TYPE_TO_WORDNET_SYNSET[ot] for ot in ALL_PICKUP_TYPES_THOR
]
